...
namespace  Casino.Games.BxB {
	...
	public class GloryPanel : UIPanel {
            ...
            switch (tabIdx)
            {
                ...
                case 1:
                   ...
                   for (int i = 0; i< page2.transform.childCount ; i++)
                    {
                        Destroy(page2.transform.GetChild(i).gameObject);
                    }
                    for (int i = 0; i < panelLines.Length; i++)
                    {
	...
	public class BirdGloryLineData : PanelLineData {
		...
		public BirdGloryLineData(string account, string timeStamp, string betLevel, string win,  bool isPotWin, bool isBigWin) {
