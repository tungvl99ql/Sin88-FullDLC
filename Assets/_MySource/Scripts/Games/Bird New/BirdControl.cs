...
namespace Core.Server.Api
{
    ...
    public class BirdControl : MonoBehaviour
    {
        ...
        /// <summary>
        /// 0-6: pieces|7-26: line|27-46: line_grey|47-48: btnLineCircle|49-55: pieces light|56-59: autoSpin
        /// |60-63: realPlayBtn|64-65: goldRush
        /// </summary>
        //public Sprite[] sprts;

        public Sprite[] betlineItemSpriteList;
        public Sprite inactivedAutoSpinSprite;
        public Sprite activeAutoSpineSprite;



        /// <summary>
        /// 0:btnLineSelectEle-popup|1-20: btnLineSelect-circle|21: changeBet|22: achive ele|23: achive panel
        /// 24:achive-top-ele|25: chartPanel|26: chartEle|27: btnSpin|28: btnSpinAuto|29: goldRushPanel|30: transGoldRush
        /// |31: bgCol
        /// </summary>
        public GameObject[] gojs;
        public ScrollRect[] scrs;
        /// <summary>
        ...
        void Start()
        {
            ...
            gamemini.EndGameBound.AddListener(EndBound);
            ...
            var req_GET_INFO = new OutBounMessage("EGYPT.GET_INFO");
        ...
        {
            OutBounMessage req_INFO_DETAIL = new OutBounMessage("EGYPT.GET_INFO_DETAIL");
        ...
        public void DoAction(string t)
        {
            switch (t)
            {
                ...
                case "spinn":
                    ...
                    spinThreads.Clear();
                    //Spin on sv
                    OutBounMessage req_SPIN = new OutBounMessage("EGYPT.START");
                    req_SPIN.addHead();
                    ...
                    for (int i = 0; i < count; i++)
                        ...
                        rsPiecesControll[i].transform.GetChild(0).GetComponent<Image>().overrideSprite = sprites[index - 1];
                ...
                case "selectAllLine":
                    ...
                    for (int i = 0; i < 20; i++)
                    {
                        ...
                        {
                            lineSelectList[i].BtnRect.sprite = betlineItemSpriteList[i];
                            //lineSelectList[i].BtnCirlce.sprite = sprts[47];
                        }
                ...
                case "deSelectAllLine":
                    ...
                    for (int i = 0; i < 20; i++)
                    {
                        lineSelectList[i].BtnRect.sprite = betlineItemSpriteList[20 + i];
                        //lineSelectList[i].BtnCirlce.sprite = sprts[48];
                ...
                case "openChangeBet":
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        txts[32 + i].text = App.FormatMoney(numList[5 + i]);
                    }
                    gojs[21].SetActive(true);
                    break;
                case "closeChangeBet":
                ...
                case "changeAutoSpin":
                    ...
                    if (boolLs[2] == false)
                    {
                        ...
                        boolLs[2] = true;
                        btns[0].image.sprite = activeAutoSpineSprite;
                        spriteState.pressedSprite = activeAutoSpineSprite;
                        //DoAction("spin");
                        NewSpin();
                    }
                    else
                    {
                        boolLs[2] = false;
                        btns[0].image.sprite = inactivedAutoSpinSprite;
                        spriteState.pressedSprite = inactivedAutoSpinSprite;
                ...
                case "changeRealPlay":
                    ...
                    if (boolLs[3] == true)          //Change to fake spin
                    {
                        ...
                        boolLs[2] = false;
                        btns[0].image.sprite = inactivedAutoSpinSprite;
                        spriteState1.pressedSprite = inactivedAutoSpinSprite;
                    }
                    else
                    {                               //change to real spin
                        boolLs[3] = true;
        ...
        public void OpenLineSelect(bool isShow)
        {
            ...
            */
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                img.sprite = lineSelectList[tmp].IsSlect ? betlineItemSpriteList[tmp] : betlineItemSpriteList[20 + i];
                ...
                btn.onClick.AddListener(() =>
                {
                    ...
                    lineSelectList[tmp].BtnRect.sprite = isSelected ? betlineItemSpriteList[tmp] : betlineItemSpriteList[20 + tmp];
                    //lineSelectList[tmp].BtnCirlce.sprite = isSelected ? sprts[47] : sprts[48];
        ...
        {
            Debug.Log(1 + "Bird : " + gamecode + " === " + Gamecode);
        ...
        public void GetDataGlory(bool isBigWin)
        {
            ...
            OutBounMessage req_Glory = new OutBounMessage("EGYPT.GLORY_BOARD");
            req_Glory.addHead();
        ...
        private void StopColumn(RectTransform[] rtf, int id)
        {
            ...
            if (rtf[0].anchoredPosition.y < -245)
                ...
                rtf[0].anchoredPosition = Vector3.MoveTowards(rtf[0].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, -240), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[1].anchoredPosition.y < -45)
                ...
                rtf[1].anchoredPosition = Vector3.MoveTowards(rtf[1].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, -40), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[2].anchoredPosition.y < 155)
                ...
                rtf[2].anchoredPosition = Vector3.MoveTowards(rtf[2].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, 160), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[3].anchoredPosition.y < 355)
                ...
                rtf[3].anchoredPosition = Vector3.MoveTowards(rtf[3].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, 360), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[4].anchoredPosition.y < 555)
                ...
                rtf[4].anchoredPosition = Vector3.MoveTowards(rtf[4].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, 560), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[5].anchoredPosition.y < 755)
                ...
                rtf[5].anchoredPosition = Vector3.MoveTowards(rtf[5].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, 760), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[6].anchoredPosition.y < 955)
                ...
                rtf[6].anchoredPosition = Vector3.MoveTowards(rtf[6].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, 960), Time.deltaTime * (2500 + (id * 300)));
            if (rtf[7].anchoredPosition.y < 1155)
                ...
                rtf[7].anchoredPosition = Vector3.MoveTowards(rtf[7].anchoredPosition, new Vector2(rtf[0].anchoredPosition.x, 1160), Time.deltaTime * (2500 + (id * 300)));
        }
        private float sizeif = -440f;
        private void Update()
        {
