...
{
    public class MainDragFeast : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            FatherDragFeast.instance.canDrag = true;
        }
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            FatherDragFeast.instance.canDrag = false;
